                ...
                <table class="table table-striped table-hover" style="font-size: 14px; color:black;">
                    ...
                    <tr>
                        ...
                        <td style="width: 1px; white-space: nowrap;">
                            <a href="Admin-viewTrainDetails.php?trainNo=<?php echo $data['trainNo']?>" title="View Details" class="text-primary infoBtn"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;&nbsp;View Details</a>
                        </td>
                        <td style="width: 1px; white-space: nowrap;">
                            <a href="Admin-viewTrainSchedule.php?trainNo=<?php echo $data['trainNo']?>&trainName=<?php echo $data['trainName']?>" title="View Schedule" class="text-info infoBtn"><i class="fa fa-calendar-check-o"></i>&nbsp;&nbsp;&nbsp;View Schedule</a>
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <div class="card-body table-responsive">
                <table class="table table-striped table-hover" style="font-size: 14px; color:black;">
                    ...
                    <tr>
                        ...
                        <td style="width: 1px; white-space: nowrap;">
                            <a href="Admin-viewTrainDetails.php?trainNo=<?php echo $data['trainNo']?>&line=<?php echo $data['lineType']?>" title="View Details" class="text-primary infoBtn"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;&nbsp;View Details</a>
                        </td>
                        <td style="width: 1px; white-space: nowrap;">
                            <a href="Admin-viewTrainSchedule.php?trainNo=<?php echo $data['trainNo']?>&trainName=<?php echo $data['trainName']?>" title="View Schedule" class="text-info infoBtn"><i class="fa fa-calendar-check-o"></i>&nbsp;&nbsp;&nbsp;View Schedule</a>
                        </td>
            ...
            <div class="card-body table-responsive">
                <table class="table table-striped table-hover" style="font-size: 14px; color:black;">
                    ...
                    <tr>
                        ...
                        <td style="width: 1px; white-space: nowrap;">
                            <a href="Admin-viewTrainDetails.php?trainNo=<?php echo $data['trainNo']?>&line=<?php echo $data['lineType']?>" title="View Schedule" class="text-primary infoBtn"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;&nbsp;View Details</a>
                        </td>
                        <td style="width: 1px; white-space: nowrap;"> 
                            <a href="Admin-viewTrainSchedule.php?trainNo=<?php echo $data['trainNo']?>&trainName=<?php echo $data['trainName']?>" title="View Schedule" class="text-info infoBtn"><i class="fa fa-calendar-check-o"></i>&nbsp;&nbsp;&nbsp;View Schedule</a>
                        </td>
