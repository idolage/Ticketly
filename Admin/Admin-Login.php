...
{  
    ...
    $sql = "Select * from admins where adminsUid = '" . $name . "' or adminsEmail = '" . $name . "'";  
...
<head>
    <title translate='no'>Admin Login | ticketly</title>
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100" style="padding: 30px 50px 30px 50px;">
                ...
                <form class="login100-form" action="" method="post">
                    ...
                    <div class="text-center p-t-12 ">
                        ...
                        <a class="txt2 " href="Admin-recoverPassword.php">
							Username / Password?
						</a>
                    </div>
                </form>
