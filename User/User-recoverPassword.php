...
<body>
    ...
    <div class="limiter"> 
        <div class="container-login100">
            <div class="wrap-login100" style="padding: 10px 40px 33px 40px;">
                ...
                <div class="text-center">
                    ...
                    <p style="text-align: center; font-size:13px;" >Further instructions will be sent to your email<br>Enter an email address to get your<BR>One-Time-Password</p>
                    ...
                    <div class="wrap-input100 validate-input " data-validate="Valid email is required: ex@abc.xyz ">
                        <input class="input100 " type="text " name="recoverEmail" placeholder="Email...">
                        <span class="focus-input100 "></span>
                        <span class="symbol-input100 ">
